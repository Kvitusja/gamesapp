...
class _GameListWidgetState extends State<GameListWidget> {
  final List<Games> myGames = [
    Games(
        ...
        gameImage: ('images/gameimage1.jpg')),
    Games(id: 2, gameName: 'Portal 2', gameImage: ('images/gameimage2.jpg')),
    Games(
        id: 3,
        gameName: 'Witcher 3: Wild Hunt',
        gameImage: ('images/gameimage3.jpg')),
    Games(id: 4, gameName: 'Tomb Rider', gameImage: ('images/gameimage4.jpg')),
    Games(
        id: 5,
        gameName: 'The Elder Scrolls 5: Skyrim',
        gameImage: ('images/gameimage5.jpg')),
    Games(
        id: 6,
        gameName: 'Counter-Strike: Global Offensive',
        gameImage: ('images/gameimage6.jpg')),
    Games(
        id: 7, gameName: 'Left 4 Dead 2', gameImage: ('images/gameimage7.jpg')),
  ];
